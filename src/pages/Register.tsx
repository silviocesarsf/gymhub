...
import RegisterConfirmEmailTokenStep from "./RegisterConfirmEmailTokenStep";
...
export default function Register() {
    ...
    const stepsComponentsMap: Record<number, StepMapInterface> = {
        ...
        2: {
            component: <RegisterConfirmEmailTokenStep />,
                    ...
                    <div className="w-full flex items-center justify-between">
                        ...
                        <div className="w-full flex items-center justify-end">
                            <Button className={`transition-colors`}
                                onClick={nextStep}
                                color={lastStep ? "blue.7" : ""}
                                variant="filled">{lastStep ? "Finalizar" : "Proximo"}</Button>
                        </div>
                    </div>
                </Paper>
            </Container>
